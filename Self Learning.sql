#
In SQL, the
WITH clause (also known as Common Table Expressions
(CTEs)) is used to define temporary 
# result sets that can be referred to within a
SELECT, 
INSERT,
UPDATE, or
DELETE statement. These temporary tables are
only available for the duration of the query,
...
VALUES
    ...
    -- John is the manager
    (2, 'Jane', 'Smith', 'Sales', 1),
    -- Jane reports to John
    (3, 'Sam', 'Brown', 'HR', NULL),
    -- Sam is an HR manager
    (4, 'Emily', 'Davis', 'Sales', 1),
    -- Emily reports to John
    (5, 'Michael', 'Johnson', 'HR', 3);
-- Michael reports to Sam
...
INSERT INTO sales
    (sale_id, employee_id, product_id, sales_amount, sale_date)
VALUES
    (1, 2, 101, 200.50, '2024-10-15'),
    -- Jane sold product 101
    (2, 2, 102, 150.00, '2024-10-16'),
    -- Jane sold product 102
    (3, 4, 101, 300.75, '2024-10-17'),
    -- Emily sold product 101
    (4, 4, 103, 100.00, '2024-10-18'),
    -- Emily sold product 103
    (5, 2, 103, 450.20, '2024-10-20');
-- Jane sold product 103
...
VALUES
    (1, 1, '2024-10-01', 1500.00),
    -- Customer 1 placed an order
    (2, 2, '2024-10-03', 650.00),
    -- Customer 2 placed an order
    (3, 3, '2024-10-05', 200.00);
-- Customer 3 placed an order

INSERT INTO transaction
    (transaction_id, acct_num, transaction_date, channel, amount)
VALUES
    (1, 101, '2024-10-01', 'ATM Withdrawal', 500.00),
    -- Account 101 made an ATM withdrawal
    (2, 102, '2024-10-02', 'ATM Withdrawal', 200.00),
    -- Account 102 made an ATM withdrawal
    (3, 101, '2024-10-03', 'ATM Withdrawal', 150.00),
    -- Account 101 made another ATM withdrawal
    (4, 103, '2024-10-04', 'ATM Withdrawal', 400.00);
-- Account 103 made an ATM withdrawal

INSERT INTO account
    (acct_num, acct_holder_name, balance)
VALUES
...
Explanation:
# The
WITH clause creates a CTE TotalSales that calculates the total sales for each employee.
# The main query then joins the employees table
with the TotalSales CTE to
return employees
...
(1st HR): 7000
# Bob
(2nd HR): 7000 + 8000 = 15000
# Charlie
(3rd HR): 7000 + 8000 + 9000 = 24000
...
HR:
# Alice
(1st HR): 7000 + 8000 + 9000 = 24000
# Bob
(2nd HR): 8000 + 9000 = 17000
# Charlie
(3rd HR): 9000


-- ✅ MySQL Query: Top 3 Employees with Max Tenure
